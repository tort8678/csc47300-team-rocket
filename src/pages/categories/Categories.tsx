      ...
      <main className="container">
        ...
        <div className="categories-container">
          ...
          <div className="category-section">
            <h2><span className="category-icon icon-library" /> Academic</h2>
          ...
          {/* Campus Life */}
          <div className="category-section">
            <h2><span className="category-icon icon-party-popper" />Campus Life</h2>
            <div className="category-list">
              <div className="category-item">
                <div className="category-info">
          ...
          {/* Career & Life */}
          <div className="category-section">
            <h2><span className="category-icon icon-briefcase-business" />Career &amp; Life</h2>
            <div className="category-list">
              <div className="category-item">
                <div className="category-info">
          ...
          {/* Entertainment */}
          <div className="category-section">
            <h2><span className="category-icon icon-gamepad-2" />Entertainment</h2>
            <div className="category-list">
              <div className="category-item">
                <div className="category-info">
                  <h3>Gaming</h3>
          ...
          {/* General */}
          <div className="category-section">
            <h2><span className="category-icon icon-message-square" />General</h2>
            <div className="category-list">
              <div className="category-item">
                <div className="category-info">
